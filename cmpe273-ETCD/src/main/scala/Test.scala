...
class Test {
	// var client: EtcdClient = EtcdClientFactory.newInstance("http://127.0.0.1:4001/")
      //var client: EtcdClient = EtcdClientFactory.newInstance("http://54.67.103.220:4001/");
       val client = new EtcdClient(URI.create("http://54.183.231.132:4001/"))
  //****************************************************************************************
...
/////////////////////////////// bank account ////////////////////////////////////////////////////////////
  ...
  //Delete 
   ...
   @RequestMapping(value=Array("/counter"), method=Array(RequestMethod.GET))
	@ResponseBody
	def counter( ): String={
		var appkey = "/010011677/counter"
		var result : EtcdResult = null
		try{
			result = this.client.get(appkey)
		}
		catch{
			case e : Exception => println("Exception: " + e)
			result = this.client.set(appkey, "0")		
		}
		result = this.client.get(appkey)
   ...
   /*def counter( ): String={
	...
	var indicator = false
   // var countValue =""
	var applicationkey = "010011677/counter"
	var res : EtcdResult = null
		
   try{
		println(" putting  " + applicationkey)
		val response = client.get(applicationkey)
